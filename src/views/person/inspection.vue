<template>
  <div class="app-container" style="min-height: 700px;">
    ...
    <el-table v-loading="loading" :data="warningTypeList">
      ...
      <el-table-column
        label="图片"
        prop="attendance_identification_absolute"
        lable="图片"
        :show-overflow-tooltip="true"
      >
        <template slot-scope="scope">
          <el-image
            :src="scope.row.attendance_identification_absolute"
      ...
      <el-table-column label="入井日期" prop="pass_time_exc" :show-overflow-tooltip="true" />
      <el-table-column label="入井时间" prop="pass_time" :show-overflow-tooltip="true" />
    </el-table>
