    ...
    <div class="insight-grid">
      ...
      <div class="insight-slot">
        <div class="hd-card">
          <div class="hd-head">
            <div class="hd-title">
              <span class="hd-title-bar hd-title-bar--orange" />
            ...
            <div class="hd-tabs">
              <button
                ...
                :key="'a-' + t.label"
                type="button"
                class="ht-tab distribution-time-button"
                :aria-pressed="selectedTime1 === t.value"
      ...
      <div class="insight-slot">
        <div class="hd-card">
          <div class="hd-head">
            <div class="hd-title">
              <span class="hd-title-bar hd-title-bar--green" />
            ...
            <div class="hd-tabs">
              <button
                ...
                type="button"
                class="ht-tab distribution-time-button"
                :aria-pressed="selectedTime3 === t.value"
          ...
          <div v-if="typeData.type.length" class="hd-legend">
            ...
            >
              <span class="hd-legend-dot" :style="{ background: palette[i % palette.length] }" />
...
export default {
  ...
  data() {
    return {
      ...
      // 8 色循环
      palette: ['#398773', '#9ac2ac', '#10b981', '#dcc7a2', '#f43f5e', '#849c91', '#06b6d4', '#ec4899']
    }
  },
          ...
          formatter: (params) => {
            ...
            return `<div style="font-weight:600;margin-bottom:2px;">${p.name}</div>
                    <div style="display:flex;align-items:center;gap:6px;">
                      <span style="display:inline-block;width:8px;height:8px;border-radius:2px;background:#c5a46c;"></span>
                      <span>报警数：</span><span style="font-weight:600;color:#c5a46c;">${p.value}</span>
                    </div>`
          }
        },
          ...
          data: this.domainData.yData.map((v, i) => ({
            ...
            itemStyle: {
              ...
              color: {
                ...
                colorStops: i % 2 === 0
                  ? [{ offset: 0, color: '#c5a46c' }, { offset: 1, color: 'rgba(255, 122, 24, 0.35)' }]
                  : [{ offset: 0, color: '#dcc7a2' }, { offset: 1, color: 'rgba(255, 169, 64, 0.35)' }],
...
.hd-title-bar--orange { background: linear-gradient(180deg, #c5a46c, #dcc7a2); }
...
.ht-tab--active { background: linear-gradient(135deg, #398773, #9ac2ac); }
.ht-tab--active:hover { color: white; }
.ht-tab:focus-visible { outline: 2px solid #398773; outline-offset: 2px; }
