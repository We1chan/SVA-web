      ...
      <tiny-row :flex="true" justify="center">
        <tiny-col :span="7">
          <div style="display: flex; align-items: center; justify-content: space-between;">
            ...
            <div>
              <span class="clickable" :style="timeStyle('1', 1)" @click="selectTime('1', 1)">周</span>
              <span style="color: grey;"> | </span>
              <span class="clickable" :style="timeStyle('2', 1)" @click="selectTime('2', 1)">月</span>
              <span style="color: grey;"> | </span>
              <span class="clickable" :style="timeStyle('3', 1)" @click="selectTime('3', 1)">季度</span>
              <span style="color: grey;"> | </span>
              <span class="clickable" :style="timeStyle('4', 1)" @click="selectTime('4', 1)">年</span>
            </div>
          </div>
          <div class="col">
            <div class="left">
        ...
        <tiny-col :span="6">
          <div style="display: flex; align-items: center; justify-content: space-between;">
            ...
            <div>
              <span class="clickable" :style="timeStyle('1', 3)" @click="selectTime('1', 3)">周</span>
              <span style="color: grey;"> | </span>
              <span class="clickable" :style="timeStyle('2', 3)" @click="selectTime('2', 3)">月</span>
              <span style="color: grey;"> | </span>
              <span class="clickable" :style="timeStyle('3', 3)" @click="selectTime('3', 3)">季度</span>
              <span style="color: grey;"> | </span>
              <span class="clickable" :style="timeStyle('4', 3)" @click="selectTime('4', 3)">年</span>
            </div>
          </div>
          <div class="col">
            <div class="left">
